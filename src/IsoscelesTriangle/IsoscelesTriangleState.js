 ...
 */
export class IsoscelesTriangleState extends State {
  constructor() {
    super(
  ...
  getThirdPointContraints() {
    ...
    let perpendicularLine = {
      segment: new Segment(
        middle,
        new Point(
          middle.x + Math.cos(perpendicularAngle) * 100,
          middle.y + Math.sin(perpendicularAngle) * 100
        )
      ),
      isInfinite: true,
    };
