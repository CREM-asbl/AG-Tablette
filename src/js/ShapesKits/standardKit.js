    ...
    shapes: [
      {
        ...
        steps: [
          ...
          { type: 'segment', x: 50, y: 0 },
          { type: 'vertex', x: 50, y: 0 },
          { type: 'segment', x: 65.450849718737, y: -47.55282581475 },
          { type: 'vertex', x: 65.450849718737, y: -47.55282581475 },
          { type: 'segment', x: 25, y: -76.94208842935 },
          { type: 'vertex', x: 25, y: -76.94208842935 },
          { type: 'segment', x: -15.450849718737, y: -47.55282581475 },
          { type: 'vertex', x: -15.450849718737, y: -47.55282581475 },
          { type: 'segment', x: 0, y: 0 },
        ],
      },

      {
        ...
        steps: [
          ...
          { type: 'segment', x: 50, y: 0 },
          { type: 'vertex', x: 50, y: 0 },
          { type: 'segment', x: 25, y: -34.40954801175 },
          { type: 'vertex', x: 25, y: -34.40954801175 },
          { type: 'segment', x: 0, y: 0 },
        ],
      },
...

      {
        ...
        steps: [
          { type: 'moveTo', x: 0, y: 0 },
          { type: 'vertex', x: 0, y: 0 },
          { type: 'segment', x: 80.9016994375, y: 0 },
          { type: 'vertex', x: 80.9016994375, y: 0 },
