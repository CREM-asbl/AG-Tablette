...
export class Canvas {
	 ...
	 */
	drawVirtualMouse(mouseCoordinates) {
		var ctx = this.ctx,
	 ...
	 */
	drawRotatingShape(shape, point, angle) {
		var tmpBuildSteps = [];
	 ...
	 */
	drawReversingShape(shape, axe, progress) {
