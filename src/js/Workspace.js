...
Workspace.prototype.addMenuAFamilies = function () {
	...
	f2.addShape("Petit losange", [
		ShapeStep.getLine(0 - 42.677669529664, 0 + 17.677669529664),
		ShapeStep.getLine(50 - 42.677669529664, 0 + 17.677669529664),
		ShapeStep.getLine(85.355339059329 - 42.677669529664, -35.355339059329 + 17.677669529664),
		ShapeStep.getLine(35.355339059329 - 42.677669529664, -35.355339059329 + 17.677669529664),
		ShapeStep.getLine(0 - 42.677669529664, 0 + 17.677669529664)
	...
	f3.addShape("Triangle obtusangle", [
		ShapeStep.getLine(0 - 43.63389981246667, 0 + 51.2947256196),
		ShapeStep.getLine(105.9016994374 - 43.63389981246667, -76.9420884294 + 51.2947256196),
		ShapeStep.getLine(25 - 43.63389981246667, -76.9420884294 + 51.2947256196),
		ShapeStep.getLine(0 - 43.63389981246667, 0 + 51.2947256196)
...
Workspace.prototype.setZoomLevel = function (newZoomLevel, doRefresh) {
	...
	this.app.canvas.updateRelativeScaleLevel(newZoomLevel / this.zoomLevel);
